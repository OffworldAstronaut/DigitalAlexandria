...
$$
Q= \Delta U + \tau \Longleftrightarrow \Delta U = Q - \tau
$$
...
![*A figura à direita (A) ilustra um cristal à 0K (zero absoluto, impossível). CC-BY-SA, via [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Figure_Showing_Entropy_at_0_K.png).*](images/laws_thermodynamics_entropy.png)
