...
![Representação estrutural do **ciclohexanol**.](images/oxygenated_functions/benOH.png)
...
![O fenol! É composto por um grupo fenil (anel benzênico sem um hidrogênio) ligado a uma hidroxila. ](images/oxygenated_functions/benOH2.png)
...
![A dupla ligação com o oxigênio é mais comum do que você pensa!](images/oxygenated_functions/carboxyle.png)
...
![Geralmente eles possuem uma cadeia looooooooooooooooooooonga! ](images/oxygenated_functions/looongOH.png)
...
![Essa é a forma geral de um anidrido! Imagine que nas pontas das ligações simples, estão ligados dois radicais orgânicos! ](images/oxygenated_functions/tripleO.png)
...
![“Anidrido” tem suas raízes no grego, significando “sem água”, por conta das reações de desidratação que originam esses compostos.](images/oxygenated_functions/C4O3H6.png)
...
![Os dois oxigênios tornam o composto bem reativo…](images/oxygenated_functions/ester.png)
...
![Esse carinha é extremamente inflamável!](images/oxygenated_functions/eter.png)
